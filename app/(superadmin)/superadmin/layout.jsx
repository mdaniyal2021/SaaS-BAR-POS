    ...
    <div className="min-h-screen bg-gray-950 flex">
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-800">
          <img src="/icons/logo.png" alt="MyEasyTill" className="h-22 w-auto object-contain shrink-0" />
          <div>
            <p className="text-white font-semibold text-sm">MyEasyTill</p>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-gray-900 border-b border-gray-800 px-4 py-3 flex items-center gap-3 lg:px-6">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs">MyEasyTill Control Panel</p>
          </div>
        </header>
